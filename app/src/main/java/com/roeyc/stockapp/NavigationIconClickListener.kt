...
// will accomplish the translation animation for the sheet
...
class NavigationIconClickListener @JvmOverloads internal constructor(
    ...
    override fun onClick(view: View) {
        ...
        val translateY = height - context.resources.getDimensionPixelSize(R.dimen.stock_product_grid_reveal_height)
